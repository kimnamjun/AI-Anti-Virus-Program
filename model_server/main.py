...
try:
    ...
    vectorizer_two, model_two = my.model.create_tfidf_and_logistic_regression_model(train_df_two, test_df_two)
    ...
    my.aws.save_to_s3(model_two, 'ava-data-model', 'two/undetermined_model.pickle')
